                    ...
                    <div class="about-content">
                        ...
                        <div class="about-content-footer">
                            ...
                            <div class="about-company-service wow fadeInUp" data-wow-delay="0.5s">
                                <div class="icon-box">
                                    <img src="images/icon-company-service-1.svg" alt="">
                                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="company-planning-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3">Thorough planning services ensuring compliance and financial
                                security</h2>
                        </div>
                        <!-- Section Title End -->
                        ...
                        <div class="company-planning-body">
                            <p class="wow fadeInUp" data-wow-delay="0.25s">simply dummy text of the printing and
